...
<body>
    ...
    * {
    ...
    $user_query = mysqli_query($con, "SELECT addedBy, userTo FROM posts WHERE id='$post_id'");
    ...
    $get_comments = mysqli_query($con, "SELECT * FROM comments WHERE postId='$post_id' ORDER BY id ASC");
    ...
    if ($count != 0) {
        while ($comment = mysqli_fetch_array($get_comments)) {
            ...
            $removed = $comment['removed'];
              ...
              //Timeframe
              $date_time_now = date("Y-m-d H:i:s");
              $start_date = new DateTime($date_added); //time of past
              ...
              ?>
                ...
                <div class="comment_section">
                    <a href="<?php echo $posted_by; ?>" target="_parent"><img src="<?php echo $user_obj->getProfilePic(); ?>" alt="profile picture" title="<?php echo $posted_by; ?>"></a>
