...
class Notification {
    ...
    public function getUnreadNumber() {
        ...
        $query = mysqli_query($this->con, "SELECT * FROM notifications WHERE viewed='no' AND userTo='$userLoggedIn'");
    ...
    public function getNotifications($data, $limit) {
            ...
            $set_viewed_query = mysqli_query($this->con, "UPDATE notifications SET viewed='yes' WHERE userTo='$userLoggedIn'");
    
            $query = mysqli_query($this->con, "SELECT * FROM notifications WHERE userTo='$userLoggedIn' ORDER BY id DESC");
            ...
            while ($row = mysqli_fetch_array($query)) {
                ...
                $user_data = mysqli_fetch_array($user_data_query);
                 ...
                 $start_date = new DateTime($row['datetime']); //time of past
            ...
            if ($count > $limit) 
                ...
                $return_string .= "<input type='hidden' class='noMoreDropdownData' value='true'> <p style='text-align: center; padding-top: 7px'>No more notifications to load!</p>";
